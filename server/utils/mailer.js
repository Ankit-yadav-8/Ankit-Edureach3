export async function sendOtpEmail(email, code) {
  ...
  try {
    ...
    await transport.sendMail({
      from: process.env.SMTP_FROM || `CollegeParichay <${process.env.SMTP_USER}>`,
      to: email,
      subject: "Your CollegeParichay verification code",
      text: `Your CollegeParichay verification code is ${code}. Valid for 5 minutes.`,
      html: `<div style="font-family:Arial,sans-serif;max-width:480px;margin:auto">
        ...
        <p style="color:#888;font-size:13px">Valid for 5 minutes. If you didn't request this, ignore email.</p>
      </div>`,
    });
    return { dev: false };
  } catch (e) {
