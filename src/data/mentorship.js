  ...
  "neet": {
    ...
    metrics: {
      ...
      parent: {
        week: "Week 6",
        rows: [
          { icon: "clock",    c: "#FF693D", l: "Study hours this week", v: "46 hrs",  note: "+8h vs last week" },
          { icon: "file",     c: "#6366f1", l: "Tests attempted",       v: "2 tests", note: "Both fully analysed" },
          { icon: "trend",    c: "#22c55e", l: "Score improvement",     v: "+12%",    note: "530 → 610 / 720" },
          { icon: "check",    c: "#0ea5a4", l: "Tasks completed",       v: "22 / 24", note: "92% consistency" },
          { icon: "activity", c: "#ef4444", l: "Attendance",           v: "98%",     note: "Active 7 of 7 days" },
        ],
