...
const EXAM_PROFILES = {
  advanced: {
    ...
    icon: Trophy,
    color: "#e05a2b",
    gradient: "linear-gradient(135deg,#F15A38 0%,#e05a2b 100%)",
    types: ["IIT"],
  ...
  return (
    <div className="page">
      ...
      <section className="warm-page-header" style={{ padding: "48px 0", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: "'Space Grotesk','Sora',sans-serif", fontWeight: 800, fontSize: "clamp(1.9rem,4.5vw,2.7rem)", margin: "10px 0 6px", display: "flex", alignItems: "center", gap: 12, color: "#1c1c28" }}>
            <span style={{ display: "grid", placeItems: "center", width: 46, height: 46, borderRadius: 14, background: "linear-gradient(135deg,#F15A38,#e05a2b)", boxShadow: "0 8px 22px -8px rgba(244,123,32,.7)" }}>
      ...
      <style>{`
        ...
        .fy-mylist-num { flex-shrink: 0; width: 22px; height: 22px; border-radius: 50%; display: grid; place-items: center; background: linear-gradient(135deg,#F15A38,#E0421F); color: #fff; font-family: "Sora",sans-serif; font-weight: 800; font-size: 11px; }
