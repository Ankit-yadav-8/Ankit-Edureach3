  ...
  if (!college) {
    return (
      <div className="page container" style={{ padding: "80px 0", textAlign: "center" }}>
        ...
        <Link to="/colleges" className="btn btn-coral" style={{ marginTop: 16 }}>Back to colleges</Link>
      </div>
    );
  }
    ...
    <div className="page">
      ...
      <div className="container" style={{ marginTop: 28 }}>
        <div className="tabs" style={{ flexWrap: "wrap", marginBottom: 24 }}>
          {TABS.map((t) => (
            <button key={t} className={`tab ${tab === t ? "active" : ""}`} onClick={() => setTabQ(t)}>{t}</button>
          ))}
        </div>
              ...
              <div className="card">
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                  {college.placements.recruiters.map((r) => (
                    <span key={r} className="pill" style={{ background: "var(--sky)", border: "1px solid var(--line)" }}>{r}</span>
                  ))}
                </div>
              ...
              <div className="grid-2" style={{ gap: 22, alignItems: "start" }}>
                <div className="card" style={{ overflowX: "auto" }}>
                  <h4 style={{ fontFamily: "Sora", fontWeight: 700, marginBottom: 12 }}>
                    All rounds · {branches.find((b) => b.code === branch)?.name} · {cat}
                  </h4>
                  ...
                  <p style={{ fontSize: 11, color: "var(--muted)", marginTop: 10 }}>
                    {college.type === "IIT"
                      ? "6 JoSAA rounds — IITs do not have CSAB. Illustrative; verify on josaa.nic.in."
                      : "6 JoSAA + 2 CSAB special rounds. Illustrative; verify on josaa.nic.in / csab.nic.in."}
                  </p>
                </div>
                <div className="card">
                  ...
                  <Bars
                    ...
                    height={300} fmt={fmtRank} angle={-30}
                  />
                </div>
              </div>
              ...
              <div className="grid-2" style={{ gap: 22, alignItems: "start", marginTop: 22 }}>
                <div className="card" style={{ overflowX: "auto" }}>
                  ...
                  <p style={{ fontSize: 12, color: "var(--muted)", marginBottom: 12 }}>
                    Year-wise opening &amp; closing rank — {branches.find((b) => b.code === branch)?.name} · {cat}
                  </p>
                  <table className="data-table">
                  ...
                  {forecast && (
                    <div style={{
                      ...
                      <span style={{ fontSize: 13, color: "var(--muted)" }}>
                        📈 Forecast for <strong style={{ color: "var(--navy)" }}>2026</strong> (from trend)
                      </span>
              ...
              <div className="grid-2" style={{ gap: 24, alignItems: "start" }}>
                ...
                <div className="card">
                  ...
                  <p style={{ fontSize: 12, color: "var(--muted)", marginTop: 12 }}>
                    Scholarships, fee waivers (SC/ST/EWS) and mess refunds can significantly reduce the net cost.
                  </p>
                </div>
              </div>
                  ...
                  <div className="card" style={{ display: "flex", flexDirection: "column", gap: 8, height: "100%" }}>
                    ...
                    {college.placements.byBranch?.[b.code] && (
                      <div style={{ marginTop: 4 }}>
                        <span className="badge teal">Avg {fmtINR(college.placements.byBranch[b.code])}</span>
                      </div>
                    )}
                    <Link
                      to={`/colleges/${slug}?tab=cutoff`}
