...
const GUIDE = [
  ...
  },
  {
    ...
    what: "Put shortlisted colleges side-by-side on fees, placements, cutoffs, rankings and location to make the final call.",
    steps: [
      "Add colleges to compare using the ⚖ icon on any college card.",
      "Open Compare from the navbar to see them side-by-side.",
      "Weigh fees, placements and cutoffs to pick your favourite.",
    ],
    help: "Turns a tough decision into a clear, data-backed choice in seconds.",
  },
  {
    n: 8,
    icon: BarChart3,
    ...
    what: "Compare JEE, BITSAT, VITEEE and other exams on pattern, difficulty, colleges and eligibility.",
    steps: [
      "Open Compare Exams from the Tools menu.",
      "Pick the exams you're considering.",
      "Review pattern, dates and the colleges each unlocks.",
    ],
    help: "Helps you decide which exams are worth your time and effort.",
  },
  {
    n: 9,
    icon: Heart,
    ...
    to: "/shortlist",
    tag: "Your wishlist",
    what: "Tap the heart on any college to save it. All your favourites live in one place for quick access.",
    steps: [
      "Tap the ♥ icon on any college card to save it.",
      "Open My Colleges (heart icon in the navbar) anytime.",
      "Revisit, compare or remove saved colleges whenever you like.",
    ],
    help: "Builds your personal wishlist so you never lose track of a college you liked.",
  },
  {
    n: 10,
    icon: ShieldCheck,
  ...
  },
  {
    ...
    what: "See every IIT, NIT and IIIT on an interactive map of India to explore colleges by region.",
    steps: [
      "Open College Map from the Tools menu.",
      "Pan and zoom across India to spot colleges near you.",
      "Tap a pin to open that college's full profile.",
    ],
    help: "Great if location matters — find strong colleges close to home.",
  },
  {
    n: 12,
    icon: BadgeCheck,
