...
const COACHING = [
  {
    name: "Allen Career Institute", city: "Kota, Rajasthan", color: "#FF693D", badge: "🏆 #1 Results",
    highlights: [
...
function diffIndex(val) {
  ...
  if (val >= 70) return { label: "Hard",      color: "#FF693D", bg: "#ffffff" };
...
function labelMeta(label) {
  ...
  if (label.includes("Hard"))    return { color: "#FF693D", bg: "#ffffff" };
    ...
    <div style={{ marginBottom: 18 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
        ...
        <div style={{ display: "flex", gap: 10, fontSize: 11, color: "var(--muted)" }}>
          <span style={{ color: "#FF693D", fontWeight: 700 }}>P1: {p1}</span>
  ...
  return (
    <div className="page">
      ...
      <style>{`
        ...
        .section-divider-adv {
          height: 3px;
          background: linear-gradient(90deg, #FF693D 0%, #7C3AED 40%, #0EA5A4 70%, #EC4899 100%);
      ...
      <PageHero
        ...
        cards={[
          ...
          { icon: Building2, accent: "#FF693D", category: "Tool", title: "IIT Branch Predictor", meta: "All 23 IITs · category-wise", badge: "LIVE" },
        ...
        <div className="container">
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 10 }}>
              ...
              <div style={{ display: "flex", gap: 14, fontSize: 12, color: "var(--muted)" }}>
                <span style={{ display: "flex", alignItems: "center", gap: 5 }}>
                  <span style={{ width: 10, height: 10, borderRadius: 2, background: "#FF693D", display: "inline-block" }} />Paper 1
                </span>
                <span style={{ display: "flex", alignItems: "center", gap: 5 }}>
          ...
          <div className="card" style={{ marginBottom: 20 }}>
            ...
            <Bars
              ...
              data={subjectBars}
              bars={[
                { key: "Paper1", label: "Paper 1", color: "#FF693D" },
      ...
      <section className="section" style={{ background: "var(--sky)", scrollMarginTop: 90 }}>
        <div className="container">
          ...
          <div className="grid-3" style={{ gap: 22, marginBottom: 22 }}>
            {[
              { label: "Physics",   data: TREND_PHYSICS,   c1: "#FF693D", c2: "#fdba74", note: "Rising steadily — application-based Modern Physics and EMI problems increasing" },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 }}>
            {[
              { icon: "⚛", color: "#FF693D", title: "Physics",   stat: "↓ eased in 2026", sub: "Climbed to a ~83 (2025 P2) peak, then eased to ~74 in 2026 as Roorkee set a more application-friendly paper" },
        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginBottom: 28 }}>
            {[
              ...
              { cat: "OBC-NCL & EWS", key: "obc_ews",   color: "#FF693D" },
          ...
          <div className="card">
                ...
                <tbody>
                  {QUALIFYING_TREND.map((row) => (
                    <tr key={row.year} className="qty-row-adv">
                      ...
                      <td style={{ textAlign: "center" }}><span style={{ fontFamily: "Sora", fontWeight: 700, color: "#FF693D" }}>{row.obc_ews} marks</span></td>
            ...
            <div style={{ marginBottom: 20, padding: "16px 20px", background: "var(--sky)", borderRadius: 12, border: "1px solid var(--line)" }}>
              ...
              <MarksBar label="OBC-NCL / EWS"  value={82} color="#FF693D" maxValue={180} />
            ...
            <Trend
              ...
              lines={[
                ...
                { key: "obc_ews",   label: "OBC-NCL & GEN-EWS", color: "#FF693D" },
        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14, marginBottom: 28 }}>
            {[
              ...
              { label: "Total Marks",  value: "360",     sub: "180 per paper",      color: "#FF693D" },
        ...
        <div className="container">
          ...
          <div style={{ position: "relative", maxWidth: 960, margin: "0 auto" }}>
            <div style={{
              ...
              background: "linear-gradient(180deg,#FF693D,#0EA5A4,#7C3AED,#EC4899,#EAB308,#15A06E)",
