...
const TYPE_COLORS = { IIT: "#FF693D", NIT: "#3b3b98", IIIT: "#0b525b" };
const TYPE_BG = {
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            <span style={{
              ...
              background: "rgba(255, 105, 61,.14)", color: "#c75b0a",
        ...
        >
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center", marginBottom: 12 }}>
              ...
              {TYPES.map((t) => (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background: type === t
                      ? (t === "All" ? "#FF693D" : (TYPE_COLORS[t] || "#FF693D"))
                      : "transparent",
            ...
            <div style={{
              ...
              onFocusCapture={(e) => e.currentTarget.style.borderColor = "#FF693D"}
            ...
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${hasFilters ? "#FF693D" : "#e5e7eb"}`,
                background: hasFilters ? "rgba(255, 105, 61,.08)" : "#fff",
                color: hasFilters ? "#FF693D" : "#6b7280",
                fontSize: 13, fontWeight: 600, cursor: "pointer",
                fontFamily: "DM Sans",
              }}
            >
              <SlidersHorizontal size={15} />
              Filters {hasFilters && <span style={{ background: "#FF693D", color: "#fff", borderRadius: 50, width: 18, height: 18, display: "grid", placeItems: "center", fontSize: 10, fontWeight: 700 }}>!</span>}
            </button>
          </div>
              ...
              >
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    background: `${TYPE_COLORS[c.type] || "#FF693D"}cc`,
                ...
                <div style={{ padding: "14px 16px 0", display: "flex", flexDirection: "column", flex: 1, gap: 10 }}>
                  ...
                  <div style={{
                    ...
                    {[
                      { icon: TrendingUp, label: "Avg", value: fmtINR(c.placements.avg), color: "#FF693D" },
