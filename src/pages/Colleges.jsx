...
const TYPE_COLORS = { IIT: "#F47B20", NIT: "#3b3b98", IIIT: "#0b525b" };
const TYPE_BG = {
        ...
        >
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center", marginBottom: 12 }}>
              ...
              {TYPES.map((t) => (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background: type === t
                      ? (t === "All" ? "#F47B20" : (TYPE_COLORS[t] || "#F47B20"))
                      : "transparent",
            ...
            <div style={{
              ...
              onFocusCapture={(e) => e.currentTarget.style.borderColor = "#F47B20"}
            ...
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${hasFilters ? "#F47B20" : "#e5e7eb"}`,
                background: hasFilters ? "rgba(244,123,32,.08)" : "#fff",
                color: hasFilters ? "#F47B20" : "#6b7280",
                fontSize: 13, fontWeight: 600, cursor: "pointer",
                fontFamily: "DM Sans",
              }}
            >
              <SlidersHorizontal size={15} />
              Filters {hasFilters && <span style={{ background: "#F47B20", color: "#fff", borderRadius: 50, width: 18, height: 18, display: "grid", placeItems: "center", fontSize: 10, fontWeight: 700 }}>!</span>}
            </button>
          </div>
              ...
              >
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    background: `${TYPE_COLORS[c.type] || "#F47B20"}cc`,
                ...
                <div style={{ padding: "14px 16px 0", display: "flex", flexDirection: "column", flex: 1, gap: 10 }}>
                  ...
                  <div style={{
                    ...
                    {[
                      { icon: TrendingUp, label: "Avg", value: fmtINR(c.placements.avg), color: "#F47B20" },
