...
const BRANCH_TABLE = [
  ...
  [51,    200,
    ["IIT Bombay EE", "IIT Delhi Mech/EE", "IIT Madras EE", "IIT Kanpur CS"],
    "IIT Bombay CSE (rank ≤65)"],
  [201,   500,
    ["IIT Bombay/Delhi/Madras EE or Eng. Physics", "IIT Kanpur CS/EE", "IIT Roorkee CSE"],
    "IIT Delhi/Madras CS (rank ≤200)"],
  [501,   1000,
    ["IIT Kanpur CS", "IIT Kharagpur CSE", "IIT Roorkee EE/CS", "IIT Guwahati CS"],
    "IIT Bombay/Delhi EE (rank ≤500)"],
  [1001,  2000,
    ["Older IITs EE/Mech/Civil", "IIT Roorkee Mech/Civil", "IIT Hyderabad CS/EE"],
    "IIT Kanpur/Kharagpur CS (rank ≤1000)"],
  [2001,  3500,
    ["Older IITs non-core branches", "Newer IITs CSE (Jodhpur, Indore, Hyderabad)", "IIT Gandhinagar EE"],
    "Older IIT EE/Mech (rank ≤2000)"],
  [3501,  5500,
    ["Newer IITs multiple branches (Mandi, Tirupati, Bhilai)", "IIT Jammu/Dharwad CSE", "IIT Goa EE/CE"],
    "Newer IIT CSE (rank ≤3500)"],
  [5501,  9000,
    ["Newer IITs Chemical/Metallurgy/Civil", "IIT Bhilai/Palakkad EE/Mech"],
    "Mid-tier IIT core branch (rank ≤5500)"],
  [9001,  15000,
    ["Newer IITs — very limited seats, difficult for General", "IIT admission extremely challenging at this rank"],
    "Newer IIT non-core branch (rank ≤9000)"],
  [15001, 23000,
    ["IIT seat extremely unlikely (General/EWS)", "Focus on NIT via JEE Main rank — NIT Trichy/Warangal/Surathkal"],
