...
const INSTITUTE_ALIASES = {
  ...
  "iit-indore":          ["technology indore"],
  "iit-gandhinagar":     ["technology gandhinagar"],
  "iit-ropar":           ["technology ropar"],
  "iit-patna":           ["technology patna"],
  "iit-mandi":           ["technology mandi"],
  "iit-jodhpur":         ["technology jodhpur"],
  "iit-bhubaneswar":     ["technology bhubaneswar"],
  "iit-tirupati":        ["technology tirupati"],
  "iit-palakkad":        ["technology palakkad"],
  "iit-jammu":           ["technology jammu"],
  "iit-dharwad":         ["technology dharwad"],
  "iit-bhilai":          ["technology bhilai"],
  "iit-goa":             ["technology goa"],
