...
───────────────────────────────────────────────────────── */
export function FloatingOrbs({ count = 5, colors = ["#F47B20", "#6366f1", "#0ea5a4", "#fbbf24", "#8b5cf6"], style = {} }) {
...
/* ─────────────────────────────────────────────────────────
   2. TYPEWRITER TEXT
───────────────────────────────────────────────────────── */
export function TypewriterText({ words, interval = 2400, style = {}, cursorColor = "#F47B20" }) {
...
───────────────────────────────────────────────────────── */
export function GradientText({ children, from = "#F47B20", via = "#fbbf24", to = "#F47B20", style = {}, animate = true }) {
  return (
    <span style={{
...
───────────────────────────────────────────────────────── */
export function GlowBorderCard({ children, color = "#F47B20", radius = 16, style = {} }) {
  return (
...
───────────────────────────────────────────────────────── */
export function CounterBadge({ value, label, color = "#F47B20", style = {} }) {
...
───────────────────────────────────────────────────────── */
export function ScrollProgressBar({ color = "linear-gradient(90deg, #F47B20, #fbbf24, #F47B20)" }) {
  ...
  return (
    <motion.div
      style={{
        ...
        boxShadow: "0 0 8px rgba(244,123,32,.6)",
      }}
    />
  );
}
