...
function CollegeLogo({ slug, name }) {
  ...
  return (
    <span style={{ width: 30, height: 30, borderRadius: 8, background: "rgba(255, 105, 61,.12)", color: "#E0421F", display: "grid", placeItems: "center", fontSize: 9.5, fontWeight: 800, flexShrink: 0, fontFamily: "'Space Grotesk','Sora',sans-serif" }}>
      {initials}
    </span>
  );
}
...
function RoundDetail({ row }) {
  ...
  const statCards = [
    ...
    { label: "Round 1 Closing", value: r1 ? fmtRank(r1.closing) : "—", color: "#FF693D" },
          ...
          {chart.length > 0 && (
            <>
              <div className="cp-cutoff-chart-head">
                <BarChart3 size={15} color="#FF693D" />
              ...
              <Bars
                ...
                bars={[
                  ...
                  { key: "Closing", label: "Closing rank", color: "#FF693D" },
                ]}
    ...
    <div>
      ...
      <div className="card">
        <h3 style={{ fontFamily: "Sora", fontWeight: 700, fontSize: "1.2rem", marginBottom: 4, display: "flex", alignItems: "center", gap: 8 }}>
          <Crosshair size={20} color="#FF693D" /> Find every college within your reach
        </h3>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: active ? "#FF693D" : "transparent",
      ...
      {isReserved && (
        <div style={{
          ...
          <Info size={16} style={{ color: "#FF693D", marginTop: 1, flexShrink: 0 }} />
          <span>
      ...
      {!results && !loading && !error && (
        <div className="cp-empty">
          <div className="cp-empty-icon"><Crosshair size={26} color="#FF693D" /></div>
        ...
        <div className="card" style={{ marginTop: 22, padding: 0, overflow: "hidden" }}>
          <div style={{
            ...
            <span className="cp-rank-legend">
              ...
              <span className="cp-legend-dot" style={{ background: "#FF693D", marginLeft: 12 }} /> Closing
