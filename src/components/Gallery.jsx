...
const FALLBACK = ["linear-gradient(135deg,#1c1c28,#2EC4B6)", "linear-gradient(135deg,#F47E20,#F4A261)", "linear-gradient(135deg,#2a2a3c,#0EA5A4)", "linear-gradient(135deg,#2d6a4f,#2EC4B6)"];
