          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "13px 16px", background: CL.cream2, borderBottom: `1px solid ${CL.line}` }}>
              <span style={{ display: "flex", gap: 6 }}>
                {["#FF693D", "#e29a2e", "#0fae6e"].map((c) => <span key={c} style={{ width: 11, height: 11, borderRadius: "50%", background: c }} />)}
              </span>
            ...
            <div style={{ padding: "20px" }}>
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
                ...
                <button style={{ background: CL.coral, color: "#fff", border: "none", borderRadius: 12, padding: "0 26px", fontFamily: CL.display, fontWeight: 800, fontSize: 15, cursor: "pointer", boxShadow: "0 8px 20px rgba(255, 105, 61,.3)" }}>
                  Predict
                </button>
              </div>
