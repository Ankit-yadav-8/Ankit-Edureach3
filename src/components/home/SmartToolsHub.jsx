...
const NEW_TOOLS = [
  { icon: Calculator, accent: "#f97316", badge: "NEW", title: "ROI Calculator",       desc: "Calculate total degree cost, EMI, scholarship savings & long-term return.",        cta: "Calculate ROI", to: "/scholarships" },
