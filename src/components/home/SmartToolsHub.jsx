            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: on ? "1.5px solid transparent" : "1.5px solid rgba(255, 105, 61,.3)",
                  background: on ? "linear-gradient(135deg,#FF693D,#E0421F)" : "#fff",
                  color: on ? "#fff" : "#c2410c",
                  boxShadow: on ? "0 10px 24px -8px rgba(255, 105, 61,.6)" : "0 2px 10px rgba(0,0,0,.05)",
                  transition: "all .25s",
                }}
              >
                ...
                <span style={{
                  ...
                  background: on ? "rgba(255,255,255,.25)" : "rgba(255, 105, 61,.12)",
                  color: on ? "#fff" : "#FF693D",
                }}>
                  {g.cards.length}
                </span>
