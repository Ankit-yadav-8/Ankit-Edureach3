...
const STATUS_META = {
  upcoming:      { label: "Upcoming",      bg: "rgba(244,123,32,.13)", color: "#F47E20",  icon: "🔜" },
  flagship:      { label: "Flagship",      bg: "rgba(244,123,32,.15)", color: "#F47E20",  icon: "⭐" },
          ...
          >
            <div className="etl-rail-card">
              <div className="etl-rail-head">
                <Calendar size={15} color="#F47E20" /> Sep 2025 → Dec 2026
              </div>
