...
const CATEGORIES = [
  { id: "all",    label: "All Colleges",  color: "#F47B20" },
...
function StatusBadge({ status, tone }) {
  const colors = {
    ...
    orange: { bg: "rgba(244,123,32,.12)", color: "#F47B20",  dot: "#F47B20" },
    ...
    >
      ...
      <div style={{ padding: "18px 18px 0", display: "flex", flexDirection: "column", flex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 12, color: "#6b7280", marginBottom: 14 }}>
          ...
          <span style={{
            background: "rgba(244,123,32,.10)", color: "#F47B20",
        ...
        <div style={{
          ...
          <Star size={11} color={u.tone === "orange" ? "#F47B20" : "#9ca3af"} />
          <span>Apply by <strong style={{ color: u.tone === "orange" ? "#F47B20" : "#374151" }}>{u.deadline}</strong></span>
        </div>
...
export default function PrivateUniversities() {
  ...
  return (
    <section className="section" id="private" style={{ background: "linear-gradient(180deg, #fff 0%, #fdf8f4 100%)" }}>
