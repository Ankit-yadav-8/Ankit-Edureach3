...
const TOOLS = [
  ...
  {
    icon: Crosshair, title: "College Predictor",
  ...
  {
    icon: BarChart3, title: "Official Cutoff Analysis",
  ...
  {
    icon: Layers, title: "Branch Explorer",
  ...
  {
    icon: Map, title: "Campus Map Explorer",
  ...
  {
    icon: ListChecks, title: "Choice List Planner",
